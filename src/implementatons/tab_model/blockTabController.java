...
public class blockTabController implements TabController {
    ...
    private void initialize() {
        ...
        for(int i=0; i<=l.getSize()-1; i++) {
            ...
            btn.setOnAction(event -> {
                ...
                inventoryCatalogue.setCategoryCombo("Blocks");
            });
        }

    }

    public blockTabController(InventoryCatalogue inventoryCatalogue) {
        this.inventoryCatalogue = inventoryCatalogue;
        l = inventoryCatalogue.getCatalogue().get("Blocks");
    }
}
