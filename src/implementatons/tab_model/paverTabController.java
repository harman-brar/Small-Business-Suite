...
public class paverTabController implements TabController {
    ...
    public paverTabController(InventoryCatalogue inventoryCatalogue) {
        this.inventoryCatalogue = inventoryCatalogue;
        l = inventoryCatalogue.getCatalogue().get("Pavers");
    }
