...
public class turfTabController implements TabController {
    ...
    public turfTabController(InventoryCatalogue inventoryCatalogue) {
        this.inventoryCatalogue = inventoryCatalogue;
        l = inventoryCatalogue.getCatalogue().get("Turf");
    }
