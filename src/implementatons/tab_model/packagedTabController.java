...
public class packagedTabController implements TabController {
    ...
    private void initialize() {
        ...
        for(int i=0; i<=l.getSize()-1; i++) {
            ...
            btn.setOnAction(event -> {
                ...
                inventoryCatalogue.setCategoryCombo("Packaged");
            });
        }

    }

    public packagedTabController(InventoryCatalogue inventoryCatalogue) {
        this.inventoryCatalogue = inventoryCatalogue;
        l = inventoryCatalogue.getCatalogue().get("Packaged");
    }
}
