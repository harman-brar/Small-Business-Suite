...
public class rwsTabController implements TabController {
    ...
    private void initialize() {
        ...
        titleLabel.setText("Retaining Wall Systems");
        ...
        for(int i=0; i<=l.getSize()-1; i++) {
            ...
            btn.setOnAction(event -> {
                ...
                inventoryCatalogue.setCategoryCombo("Retaining Wall Systems");
            });
        }

    }

    public rwsTabController(InventoryCatalogue inventoryCatalogue) {
        this.inventoryCatalogue = inventoryCatalogue;
        l = inventoryCatalogue.getCatalogue().get("Retaining Wall Systems");
    }
}
