...
public class tpTabController implements TabController {
    ...
    private void initialize() {
        ...
        for(int i=0; i<=l.getSize()-1; i++) {
            ...
            btn.setOnAction(event -> {
                ...
                inventoryCatalogue.setCategoryCombo("Ties/Posts");
            });
        }

    }

    public tpTabController(InventoryCatalogue inventoryCatalogue) {
        this.inventoryCatalogue = inventoryCatalogue;
        l = inventoryCatalogue.getCatalogue().get("Ties/Posts");
    }
}
